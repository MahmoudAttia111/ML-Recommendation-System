# -*- coding: utf-8 -*-
"""
Created on Thu Jul 10 10:55:19 2025
...
class ContentBasedRecommender:
    ...
    def __init__(self, items_df=None):
        ...
        self.user_profiles = pickle.load(open(fr"user_profiles.p", "rb"))
        self.tfidf_matrix = pickle.load(open(fr"tfidf_matrix.p", "rb"))
        self.item_ids = pickle.load(open(fr"item_ids.p", "rb"))
        self.model = pickle.load(open(fr"recommend_model.p", "rb"))
